...
from . import views
from .views import leave_logs,manual_attendance_entry,custom_login_view ,export_holiday_pdf
...
urlpatterns = [
    ...
    path('manual-attendance/', manual_attendance_entry, name='manual_attendance'),
